...
인간의 설계 초안을 기반으로, TechSpec의 Functional Requirements(Given/When/Then)와 교차 검증하며 데이터 모델, 비즈니스 규칙, Usecase, 컴포넌트 아키텍처를 설계한다. 초안의 결정을 존중하되, TC 분석과 충돌하면 충돌 사항을 보고한다.
...
### 3-3. Component Tree, Specs, State, Visual Contract
